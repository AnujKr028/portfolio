...
>
  Send <FontAwesomeIcon icon={faArrowRight} />
        ...
        {/* create a small message by admin with its rounded and small profile photo  */} 
        <div className="ml-10">  
            <img src="https://qph.cf2.quoracdn.net/main-qimg-a4df9e91dcd1f12c00d554743ea7d8cf-lq" alt=""  
             className="w-16 h-16 rounded-full" />
            <p className="font-bold text-2xl w-80 leading-8 text-left  mt-5  text-gray">Hi, I’m Anuj! Let’s chat about your amazing ideas and projects.</p> 
            <p className="w-80 mt-5 page-para">"I enjoy translating your thoughts to our diversely skilled team for the best results"</p> 
            
            
            <a href="mailto:xyz@gmail.com" className=" mt-4 mb-4 inline-flex items-center gap-4 px-4 py-2  bg-blue-500 text-white rounded-lg shadow-lg hover:bg-transparent hover:border transition duration-300"> 
  <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    <path fillRule="evenodd" d="M2 5.5A2.5 2.5 0 014.5 3h11A2.5 2.5 0 0118 5.5v9A2.5 2.5 0 0115.5 17h-11A2.5 2.5 0 012 14.5v-9zM4.5 4a.5.5 0 00-.5.5v9a.5.5 0 00.5.5h11a.5.5 0 00.5-.5v-9a.5.5 0 00-.5-.5h-11z" clipRule="evenodd" />
  </svg>
  ...
  <div className="mt-4">
    <a href="https://www.linkedin.com/in/anuj-kumar-48b4a1295/" className="hover:text-blue-500 mx-3 transition duration-300">
      LinkedIn
    </a>
    <a href="https://github.com/" className="hover:text-blue-500 mx-3 transition duration-300">
      GitHub
    </a>
    <a href="mailto:xyz@gmail.com" className="hover:text-blue-500 mx-3 transition duration-300">
      Email
    </a>
  </div>
</footer>
